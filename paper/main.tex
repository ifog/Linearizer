...
These environments serve as controlled benchmarks for isolating the stability
effect; the full-scale Atari benchmark~\citep{mnih2015human} requires pixel inputs
and convolutional backbones that are orthogonal to our contribution, and we leave
that integration to future work.
