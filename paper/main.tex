...
space; we use its closed-form-collapse property and not the compositional or
SVD machinery.
...
approximator.
Only the planning model converges under repeated application of its learned
...
and targets can drift or explode.

This raises the question we take up here: can we parameterize a neural value
...
$\cT(\cdot;s)$ is a per-state contraction in latent space, not a Bellman
